...
import { dragDropDemo } from '@/components/templates/InteractiveDiagramGame/data';
...
export default function DragDropDemoPage() {
  ...
  const handleComplete = useCallback((score: number) => {
    console.log('[DragDrop Demo] Final score:', score);
  }, []);
    ...
    <div className={`min-h-screen py-8 px-4 ${isDark ? 'bg-background' : 'bg-background'}`}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="text-muted-foreground text-sm">Label the parts of a human heart by dragging labels onto zones</p>
        </div>
        <InteractiveDiagramGame
          blueprint={dragDropDemo}
