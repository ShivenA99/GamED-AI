 ...
 * Supports keyboard navigation, submenus, checkbox items, and radio groups.
 *
 * @example
 * ```tsx
 * <DropdownMenu>
...
/** Group for organizing related menu items */
...
/** Radio group for mutually exclusive menu options */
const DropdownMenuRadioGroup = DropdownMenuPrimitive.RadioGroup

/** Trigger for opening a submenu (shows chevron) */
...
/** Main dropdown content container with animation */
...
/** Radio menu item with filled circle indicator */
